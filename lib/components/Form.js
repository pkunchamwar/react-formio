...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentDidMount = function () {
    ...
    if (src) {
      _this2.createPromise = new _Form2.default(_this2.element, src, options).render().then(function (formio) {
        _this2.formio = formio;
        _this2.formio.src = src;
      });
    }
    if (form) {
      _this2.createPromise = new _Form2.default(_this2.element, form, options).render().then(function (formio) {
        _this2.formio = formio;
  ...
  this.componentWillReceiveProps = function (nextProps) {
    ...
    if (src !== nextProps.src) {
      _this2.createPromise = new _Form2.default(_this2.element, nextProps.src, options).render().then(function (formio) {
        _this2.formio = formio;
    ...
    if (form !== nextProps.form) {
      _this2.createPromise = new _Form2.default(_this2.element, nextProps.form, options).render().then(function (formio) {
        _this2.formio = formio;
        _this2.formio.form = form;
      });
      _this2.initializeFormio();
