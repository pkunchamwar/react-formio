...
_class.propTypes = {
  ...
  options: _propTypes2.default.shape({
    ...
    templates: _propTypes2.default.any
  }),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentDidMount = function () {
    ...
    if (src) {
      _this2.createPromise = new _Form2.default(_this2.element, src, options).then(function (formio) {
        _this2.formio = formio;
        _this2.formio.src = src;
      });
    }
    if (form) {
      _this2.createPromise = new _Form2.default(_this2.element, form, options).then(function (formio) {
        _this2.formio = formio;
  ...
  this.initializeFormio = function () {
    if (_this2.createPromise) {
      _this2.createPromise.then(function () {
        ...
        _this2.formio.on('formLoad', _this2.emit('onFormLoad'));
  ...
  this.componentWillReceiveProps = function (nextProps) {
    ...
    if (src !== nextProps.src) {
      _this2.createPromise = new _Form2.default(_this2.element, nextProps.src, options).then(function (formio) {
        _this2.formio = formio;
    ...
    if (form !== nextProps.form) {
      _this2.createPromise = new _Form2.default(_this2.element, nextProps.form, options).then(function (formio) {
        _this2.formio = formio;
        _this2.formio.form = form;
      });
      _this2.initializeFormio();
